...
const mapDispatchToProps = (dispatch, { dataService }) => {
   ...
   return {
      fetchFilteredItems: fetchFilteredItems(dataService, dispatch, 'category', 'Accessories'),
      onAddedToCart: (id) => {
         dispatch(addToCart(id))
      }
   }
}
export default Wrapper()(connect(mapStateToProps, mapDispatchToProps)(Accessories));